...
window.NETWORK_LINKS = [
  { domain: "calc-hq.com",              name: "Calc-HQ",                  url: "https://calc-hq.com/",              description: "Financial calculator hub",              live: false },
  ...
  { domain: "salaryvsinflation.com",    name: "SalaryVsInflation.com",    url: "https://salaryvsinflation.com/",    description: "Salary vs inflation calculator",        live: true },
  { domain: "hourly2salarycalc.com",    name: "Hourly2SalaryCalc.com",    url: "https://hourly2salarycalc.com/",    description: "Hourly to salary calculator",           live: true },
  { domain: "payrolldatechecker.com",   name: "PayrollDateChecker.com",   url: "https://payrolldatechecker.com/",   description: "Payroll date calculator",               live: true },
  ...
  { domain: "totalcompcalc.com",        name: "TotalCompCalc.com",        url: "https://totalcompcalc.com/",        description: "Total compensation calculator",         live: true },
  { domain: "overtimepaycalc.com",      name: "OvertimePayCalc.com",      url: "https://overtimepaycalc.com/",      description: "Overtime pay calculator",               live: true },
...
window.renderFooter = function renderFooter(currentDomain) {
  ...
  footerTarget.innerHTML = [
    '<div class="footer-grid">',
      ...
      '<div>',
        '<h2>Resources</h2>',
        '<p><a href="https://calc-hq.com/" target="_blank" rel="noopener">Financial Calculator Hub</a></p>',
        '<h2>Contact</h2>',
